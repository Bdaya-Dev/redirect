...
class AndroidOptions {
  ...
  static AndroidOptions decode(Object result) {
    ...
    return AndroidOptions(
      useCustomTabs: result[0]! as bool,
      showTitle: result[1]! as bool,
      enableUrlBarHiding: result[2]! as bool,
      toolbarColor: result[3] as int?,
      secondaryToolbarColor: result[4] as int?,
    );
  }
...
class RunRequest {
  ...
  static RunRequest decode(Object result) {
    ...
    return RunRequest(
      ...
      callbackUrlScheme: result[2]! as String,
      preferEphemeral: result[3]! as bool,
      timeoutMillis: result[4] as int?,
      androidOptions: result[5]! as AndroidOptions,
    );
  }
...
class RedirectHostApi {
  ...
  Future<bool> supportsCustomTabs() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.redirect_android.RedirectHostApi.supportsCustomTabs$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
